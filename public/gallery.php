...
<style>
  ...
  <header class="bg-white border-b border-gray-200 p-6 gallery-hero">
    <div class="max-w-6xl mx-auto text-center">
      <h1 class="text-5xl font-bold text-white py-16">Gallery</h1>
      <p class="mt-2 text-white">Explore moments from our community programs, workshops, and events that bring change to life.</p>
    </div>
  </header>
