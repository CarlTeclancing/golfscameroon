...
<div class="flex items-center justify-between mb-4">
  ...
  <div class="flex gap-2">
    <a href="<?php echo base_url('admin/member_form.php'); ?>" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition font-medium"><i class="bi bi-plus-circle"></i> New Member</a>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
    <?php foreach ($members as $m): ?>
      <div class="bg-white p-4 rounded shadow">
        ...
        <div class="mt-3">
          <a class="text-green-600 hover:underline font-medium mr-3" href="<?php echo base_url('admin/member_form.php') . '?id=' . e($m['id']); ?>"><i class="bi bi-pencil-square"></i> Edit</a>
