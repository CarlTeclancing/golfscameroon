...
<div class="flex items-center justify-between mb-4">
  ...
  <div class="flex gap-2">
    <a href="<?php echo base_url('admin/blog_form.php'); ?>" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition font-medium"><i class="bi bi-plus-circle"></i> New Post</a>
    ...
    <tbody>
      <?php foreach ($posts as $p): ?>
        <tr class="border-t">
          ...
          <td class="p-3">
          <a class="text-green-600 hover:underline font-medium mr-3" href="<?php echo base_url('admin/blog_form.php') . '?id=' . e($p['id']); ?>"><i class="bi bi-pencil-square"></i> Edit</a>
